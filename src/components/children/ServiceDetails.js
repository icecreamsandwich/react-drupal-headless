...
class ServiceDetails extends Component {
    ...
    if (service_details) {
      this.state = {
        ...
        field_service_owner_name:
          service_details.field_service_owner_name || '',
      };
    }
  }
  ...
  handleSubmit = event => {
    ...
    console.log(
      this.state.field_service_name +
        ',' +
        this.state.field_remedy_slu +
  ...
  render() {
    ...
    if (
      !this.state ||
      !this.state.field_service_name ||
      this.state.field_service_name.length === 0
    ) {
      return <Redirect to="/servicenames" push={true} />;
    }
    return (
      <React.Fragment>
        <ErrorCatcher>
              ...
              <table className="table">
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      value={this.state.field_service_name}
                      onChange={e => {
                        this.handleChange(e);
                      }}
                      readonly="readonly"
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name="field_remedy_slu"
                      value={this.state.field_remedy_slu}
                      onChange={e => {
                        this.handleChange(e);
                      }}
                      readonly="readonly"
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name="field_p_environment"
                      value={this.state.field_p_environment}
                      onChange={e => {
                        this.handleChange(e);
                      }}
                      readonly="readonly"
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name="field_service_owner_name"
                      value={this.state.field_service_owner_name}
                      onChange={e => {
                        this.handleChange(e);
                      }}
                      readonly="readonly"
